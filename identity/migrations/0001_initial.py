    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_identity', models.UUIDField(default=uuid.uuid4, editable=False, help_text='Unique identifier for the school.', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('national_id_or_birth_cert_name', models.CharField(help_text='For student provide the full name on the birth certificate. For a parent provide the name on th ID card', max_length=100)),
